                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <select class="form-select @error('motorizacao') is-invalid @enderror" name="motorizacao" required>
                                    ...
                                    <option value="3.0" {{ old('motorizacao') == '3.0' ? 'selected' : '' }}>3.0</option>
                                    <option value="4.0" {{ old('motorizacao') == '4.0' ? 'selected' : '' }}>4.0</option>
                                    <option value="5.0" {{ old('motorizacao') == '5.0' ? 'selected' : '' }}>5.0</option>
                                    <option value="6.0" {{ old('motorizacao') == '6.0' ? 'selected' : '' }}>6.0</option>
                                    <option value="7.0" {{ old('motorizacao') == '7.0' ? 'selected' : '' }}>7.0</option>
                                    <option value="8.0" {{ old('motorizacao') == '8.0' ? 'selected' : '' }}>8.0</option>
                                </select>
