...
@section('title', 'Área Administrativa - Editar Veículo')
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.veiculos.update', $veiculo->id) }}">
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-select" id="tipo_veiculo_id" name="tipo_veiculo_id" required>
                                    ...
                                    @foreach($tiposVeiculos as $tipo)
                                        <option value="{{ $tipo->id }}" {{ (old('tipo_veiculo_id') ?? $veiculo->tipo_veiculo_id) == $tipo->id ? 'selected' : '' }}>{{ $tipo->nome }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="cidade" name="cidade" value="{{ old('cidade') ?? $veiculo->cidade }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="number" step="0.01" class="form-control" id="preco" name="preco" value="{{ old('preco') ?? $veiculo->preco }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="url" class="form-control" id="foto_url_1" name="foto_url_1" value="{{ old('foto_url_1') ?? $veiculo->foto_url_1 }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="url" class="form-control" id="foto_url_2" name="foto_url_2" value="{{ old('foto_url_2') ?? $veiculo->foto_url_2 }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="url" class="form-control" id="foto_url_3" name="foto_url_3" value="{{ old('foto_url_3') ?? $veiculo->foto_url_3 }}">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="descricao" name="descricao" rows="4">{{ old('descricao') ?? $veiculo->descricao }}</textarea>
                                @error('descricao')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
